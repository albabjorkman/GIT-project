...
/***************************************************************************
 Artdatabanken
                                 A QGIS plugin
 Getting data from Artdatabanken, area, species and WFS data. Load data from three different parts
 Generated by Git_pictures Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2024-11-20
        git sha              : $Format:%H$
...
class Artdatabanken:
    ...
    # Information from QGIS plug in builder about the different parameters
    def add_action(
            self,
            icon_path,
            text,
    ...
    def run(self):
        ...
        # Show first pop-up window to start program
        self.Fpop.show()

        # See if loadButton was pressed
        self.Fpop.loadDataButton.clicked.connect(self.show_second_dialog)

    # function to load next pop-up windows depending if checkbox is checked or not
    def show_second_dialog(self):
        ...
        if area_info_checked:
            self.dlg = ArtdatabankenDialog() # get UI
    ...
    # get pop-up for attributes for WFS
    ...
    # options for species and the loading options
    def art_type(self):
